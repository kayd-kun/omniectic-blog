...
export default function CyberSecurity({ allBlogsData }: {
    allBlogsData: {
        id: string,
        date: string,
        title: string,
    ...
    const sortedCSBlogs = allBlogsData.filter((blog) => blog.tag === "Cyber Security");
    // console.log(`Sorted CS: ${sortedCSBlogs}`);
